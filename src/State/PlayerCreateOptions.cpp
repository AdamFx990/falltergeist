...
namespace Falltergeist
{
    namespace State
    {
        ...
        void PlayerCreateOptions::init()
        {
            ...
            auto saveButton = new UI::ImageButton(UI::ImageButton::Type::OPTIONS, backgroundX+14, backgroundY+18);
            auto loadButton = new UI::ImageButton(UI::ImageButton::Type::OPTIONS, backgroundX+14, backgroundY+18+37);
            auto printToFileButton = new UI::ImageButton(UI::ImageButton::Type::OPTIONS, backgroundX+14, backgroundY+18+37*2);
            auto eraseButton = new UI::ImageButton(UI::ImageButton::Type::OPTIONS, backgroundX+14, backgroundY+18+37*3);
            auto doneButton = new UI::ImageButton(UI::ImageButton::Type::OPTIONS, backgroundX+14, backgroundY+18+37*4);
